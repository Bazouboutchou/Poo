...
public class SingletonEntier {
	private int data[];
	private int size;
	private int current_size;
	
	private static SingletonEntier INSTANCE = null;
	
	private SingletonEntier(int size){
		this.size = size;
		this.current_size = 0;
		this.data = new int [size];
	}

	private SingletonEntier(){

	}
	public static SingletonEntier getInstance(int size){
		INSTANCE = new SingletonEntier(size); 
		return INSTANCE;
	}
